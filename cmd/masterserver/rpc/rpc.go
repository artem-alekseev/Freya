...
func RegisterPackets() {
	...
	g_RPCHandler.Register(rpc.SetCharacterPremium, SetCharacterPremium)
	...
	g_RPCHandler.Register(rpc.OpenQuest, OpenQuest)
	g_RPCHandler.Register(rpc.SaveQuestUI, SaveQuestUI)
	g_RPCHandler.Register(rpc.SaveQuestNPCFlags, SaveQuestNPCFlags)
	g_RPCHandler.Register(rpc.CloseQuest, CloseQuest)
	...
	g_RPCHandler.Register(rpc.SaveStatDistribution, SaveStatDistribution)
	...
	g_RPCHandler.Register(rpc.ConsumeItem, ConsumeItem)
	...
	g_RPCHandler.Register(rpc.TradeItems, TradeItems)
	g_RPCHandler.Register(rpc.EnchantItem, EnchantItem)
	g_RPCHandler.Register(rpc.ForceCoreEnchant, ForceCoreEnchant)
	g_RPCHandler.Register(rpc.AttachItem, AttachItem)
	g_RPCHandler.Register(rpc.LoadCashInventory, LoadCashInventory)
	g_RPCHandler.Register(rpc.AddCashItems, AddCashItems)
	g_RPCHandler.Register(rpc.UseCashItem, UseCashItem)
